...
namespace MyGame
{
    public class UtilityFunctions
    {
        ...
        private readonly List<Sprite> _Animations = new List<Sprite>();
        ...
        public void UpdateAnimations()
        {
            ...
            foreach (Sprite s in _Animations)
            {
                ...
                if (s.animationHasEnded) ended.Add(s);
            }
        ...
        {
            foreach (Sprite s in _Animations) SwinGame.DrawSprite(s);
        }

        public void DrawAnimationSequence()
        {
            for (var i = 1; i < ANIMATION_CELLS * FRAMES_PER_CELL; i++)
            {
                UpdateAnimations();
                DrawScreen();
            }
